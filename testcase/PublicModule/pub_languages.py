...
#---------------EBST  公共部分 ----------------------
class pub_languages(unittest.TestCase):

    def setUp(self):

        # 文档获取网站多语言接口：http://beta-store.elfbar.com/languages
        # 实际地址：https://beta-store.elfbar.com/coreapi/languages

        self.Url = Url().test_url()+"/coreapi/languages"
        print(self.Url)

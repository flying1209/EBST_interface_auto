...
#---------------EBST  公共部分 ----------------------
class pub_footer(unittest.TestCase):

    def setUp(self):

        # 文档网站头部相关数据接口：http://beta-store.elfbar.com/footer
        # 实际地址：http://beta-store.elfbar.com/coreapi/footer

        self.Url = Url().test_url()+"/coreapi/footer"
        print(self.Url)

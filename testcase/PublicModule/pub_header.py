...
#---------------EBST  公共部分 ----------------------
class pub_header(unittest.TestCase):

    def setUp(self):

        # 文档网站头部相关数据接口：http://beta-store.elfbar.com/header
        # 实际地址：http://beta-store.elfbar.com/coreapi/header

        self.Url = Url().test_url()+"/coreapi/header"
        print(self.Url)

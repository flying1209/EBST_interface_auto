...
#---------------EBST  公共部分 ----------------------
class pub_auth_me(unittest.TestCase):

    def setUp(self):

        # 文档获取用户授权信息：http://beta-store.elfbar.com/auth/me
        # 实际地址：https://beta-store.elfbar.com/coreapi/auth/me

        self.Url = Url().test_url()+"/coreapi/auth/me"
        print(self.Url)

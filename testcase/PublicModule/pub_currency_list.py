...
#---------------EBST  公共部分 ----------------------
class pub_currency_list(unittest.TestCase):

    def setUp(self):

        # 文档获取币种列表接口：http://beta-store.elfbar.com/currency-list
        # 实际地址：https://beta-store.elfbar.com/coreapi/currency-list

        self.Url = Url().test_url()+"/coreapi/currency-list"
        print(self.Url)

...
#---------------EBST  商品详情页  ----------------------
class good_allowed_countries(unittest.TestCase):

    def setUp(self):

        # 文档货品信息接口：http://beta-store.elfbar.com/goods/{goods_id}/allowed-countries

        self.Url = Url().test_url()+"/coreapi/goods/5437/allowed-countries"
        print(self.Url)

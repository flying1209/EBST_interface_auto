...
#---------------EBST  商品详情页  ----------------------
class good_relation(unittest.TestCase):

    def setUp(self):

        # 文档相关商品信息接口：http://beta-api.elfbar.com/goods/{goods_id}/relation-goods
        # 实际地址：https://beta-store.elfbar.com/coreapi/goods/5437/relation-goods

        self.Url = Url().test_url()+"/coreapi/goods/981/relation-goods"
        print(self.Url)
